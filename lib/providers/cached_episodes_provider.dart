...
class CachedEpisodesNotifier extends _$CachedEpisodesNotifier {
  ...
  Future<void> removeSeriesFromCache(String seriesName) async {
    ...
    final currentCached = stateValue ?? <ShowInfo>[];
    final filteredCache =
        currentCached.where((episode) => episode.show != seriesName).toList();
...
@riverpod
Future<List<ShowInfo>> filteredCombinedEpisodes(
  Ref ref,
  String searchTerm,
) async {
