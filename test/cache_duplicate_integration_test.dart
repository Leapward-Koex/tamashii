...
void main() {
  group('Cache Duplicate Integration Tests', () {
    ...
    test('should prevent storing duplicate episodes in real cache', () async {
      ...
      var cachedState = await container.read(cachedEpisodesProvider.future);
      ...
      cachedState = await container.read(cachedEpisodesProvider.future);
      expect(cachedState, hasLength(1));
      expect(
        cachedState[0].imageUrl,
        'version2.jpg',
    ...
    test(
      'should preserve episodes from different shows with same episode numbers',
      () async {
        final cachedNotifier = container.read(cachedEpisodesProvider.notifier);
    ...
    test(
      'should maintain duplicate prevention across cache rebuilds',
      () async {
        final cachedNotifier = container.read(cachedEpisodesProvider.notifier);
